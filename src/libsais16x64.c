...
#if 1
    extern void libsais16x64_prefetchr(const void *);
    extern void libsais16x64_prefetchw(const void *);
    #define libsais16x64_prefetchr(address) libsais16x64_prefetchr((const void *)(address))
    #define libsais16x64_prefetchw(address) libsais16x64_prefetchw((const void *)(address))
