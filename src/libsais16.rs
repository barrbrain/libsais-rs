...
extern "C" {
    ...
    fn libsais16_prefetchr(_: *const std::ffi::c_void);
    fn libsais16_prefetchw(_: *const std::ffi::c_void);
}
...
unsafe extern "C" fn libsais16_create_ctx_main(
    ...
    return 0 as *mut LIBSAIS_CONTEXT;
}
...
unsafe extern "C" fn libsais16_flip_suffix_markers_omp(
    ...
    let mut omp_block_stride: fast_sint_t = l as std::ffi::c_long / omp_num_threads
...
unsafe extern "C" fn libsais16_gather_lms_suffixes_16u_omp(
    ...
    let mut omp_thread_num: fast_sint_t = 0 as std::ffi::c_int as fast_sint_t;
    let mut omp_num_threads: fast_sint_t = 1 as std::ffi::c_int as fast_sint_t;
    let mut omp_block_stride: fast_sint_t = n as std::ffi::c_long / omp_num_threads
        & -(16 as std::ffi::c_int) as std::ffi::c_long;
    let mut omp_block_start: fast_sint_t = omp_thread_num * omp_block_stride;
    let mut omp_block_size: fast_sint_t = if omp_thread_num
        < omp_num_threads - 1 as std::ffi::c_int as std::ffi::c_long
...
unsafe extern "C" fn libsais16_initialize_buckets_start_and_end_16u(
    ...
    return (k + 1 as std::ffi::c_int as std::ffi::c_long) as sa_sint_t;
}
            ...
            as std::ffi::c_long
    {
        ...
        while i >= j {
            ...
            let mut q0: sa_sint_t = p0
                & -(2147483647 as std::ffi::c_int) - 1 as std::ffi::c_int ^ s;
            s = s ^ q0;
            *SA
                .offset(
                    (i - 0 as std::ffi::c_int as std::ffi::c_long) as isize,
...
unsafe extern "C" fn libsais16_renumber_lms_suffixes_16u_omp(
    ...
    let mut omp_thread_num: fast_sint_t = 0 as std::ffi::c_int as fast_sint_t;
    let mut omp_num_threads: fast_sint_t = 1 as std::ffi::c_int as fast_sint_t;
    let mut omp_block_stride: fast_sint_t = m as std::ffi::c_long / omp_num_threads
        & -(16 as std::ffi::c_int) as std::ffi::c_long;
    let mut omp_block_start: fast_sint_t = omp_thread_num * omp_block_stride;
    let mut omp_block_size: fast_sint_t = if omp_thread_num
        < omp_num_threads - 1 as std::ffi::c_int as std::ffi::c_long
...
unsafe extern "C" fn libsais16_renumber_distinct_lms_suffixes_32s_4k_omp(
    ...
    return name - 1 as std::ffi::c_int;
}
...
unsafe extern "C" fn libsais16_final_bwt_scan_left_to_right_16u(
    ...
    while i < j {
        ...
        libsais16_prefetchr(
            (if s0 > 0 as std::ffi::c_int { Ts0 } else { 0 as *const uint16_t })
                as *const std::ffi::c_void,
        );
        Ts0 = Ts0.offset(-1);
        Ts0;
        ...
        let mut Ts1: *const uint16_t = (&*T.offset(s1 as isize) as *const uint16_t)
            .offset(-(1 as std::ffi::c_int as isize));
        libsais16_prefetchr(
            (if s1 > 0 as std::ffi::c_int { Ts1 } else { 0 as *const uint16_t })
                as *const std::ffi::c_void,
        );
        Ts1 = Ts1.offset(-1);
        Ts1;
...
unsafe extern "C" fn libsais16_final_bwt_scan_left_to_right_16u_omp(
    ...
    *SA
        .offset(
            fresh162 as isize,
        ) = n as sa_sint_t - 1 as std::ffi::c_int
        | ((((*T.offset((n as sa_sint_t - 2 as std::ffi::c_int) as isize)
            as std::ffi::c_int)
        ...
        *SA
        ...
        if p0 > 0 as std::ffi::c_int {
            ...
            *SA
            ...
            let mut t: sa_sint_t = c0 as std::ffi::c_int
                | -(2147483647 as std::ffi::c_int) - 1 as std::ffi::c_int;
        ...
        *SA
        ...
        if p1 > 0 as std::ffi::c_int {
            ...
            *SA
            ...
            let mut t_0: sa_sint_t = c0_0 as std::ffi::c_int
                | -(2147483647 as std::ffi::c_int) - 1 as std::ffi::c_int;
        ...
        *SA.offset(i as isize) = p & 2147483647 as std::ffi::c_int;
        if p > 0 as std::ffi::c_int {
            ...
            *SA.offset(i as isize) = c1_1 as sa_sint_t;
            let mut t_1: sa_sint_t = c0_1 as std::ffi::c_int
                | -(2147483647 as std::ffi::c_int) - 1 as std::ffi::c_int;
...
unsafe extern "C" fn libsais16_main_32s_entry(
    ...
    return libsais16_main_32s_recursion(
        T,
        SA,
        n,
        k,
...
unsafe extern "C" fn libsais16_main_16u(
    ...
    return libsais16_induce_final_order_16u_omp(
        T,
        SA,
        n,
        k,
...
pub unsafe extern "C" fn libsais16_create_ctx() -> *mut std::ffi::c_void {
    return libsais16_create_ctx_main(1 as std::ffi::c_int) as *mut std::ffi::c_void;
}
#[no_mangle]
...
pub unsafe extern "C" fn libsais16_int(
    ...
    return libsais16_main_int(T, SA, n, k, fs, 1 as std::ffi::c_int);
}
#[no_mangle]
...
unsafe extern "C" fn libsais16_unbwt_create_ctx_main(
    ...
    libsais16_free_aligned(ctx as *mut std::ffi::c_void);
    return 0 as *mut LIBSAIS_UNBWT_CONTEXT;
}
...
unsafe extern "C" fn libsais16_unbwt_compute_histogram(
    ...
    i = 0 as std::ffi::c_int as fast_sint_t;
    while i < n {
        let ref mut fresh209 = *count.offset(*T.offset(i as isize) as isize);
...
unsafe extern "C" fn libsais16_unbwt_calculate_P(
    ...
    while i < j {
        ...
        let ref mut fresh210 = *bucket2.offset(c as isize);
    ...
    while i_0 <= j_0 {
        ...
        let ref mut fresh212 = *bucket2.offset(c_0 as isize);
...
unsafe extern "C" fn libsais16_unbwt_main_ctx(
    ...
    return if !ctx.is_null() && !((*ctx).bucket2).is_null()
...
pub unsafe extern "C" fn libsais16_unbwt_create_ctx() -> *mut std::ffi::c_void {
    return libsais16_unbwt_create_ctx_main(1 as std::ffi::c_int)
        as *mut std::ffi::c_void;
}
#[no_mangle]
...
pub unsafe extern "C" fn libsais16_unbwt(
    ...
    return libsais16_unbwt_aux(T, U, A, n, freq, n, &mut i);
}
#[no_mangle]
pub unsafe extern "C" fn libsais16_unbwt_ctx(
    ...
    return libsais16_unbwt_aux_ctx(ctx, T, U, A, n, freq, n, &mut i);
}
#[no_mangle]
...
pub unsafe extern "C" fn libsais16_unbwt_aux_ctx(
    ...
    return libsais16_unbwt_main_ctx(
