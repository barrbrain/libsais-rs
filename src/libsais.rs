        ...
        while t < threads as std::ffi::c_long {
            ...
            *fresh0 = thread_buckets;
            thread_buckets = thread_buckets
                .offset(
                    (4 as std::ffi::c_int
                        * ((1 as std::ffi::c_int) << 8 as std::ffi::c_int)) as isize,
                );
...
unsafe extern "C" fn libsais_free_thread_state(
...
unsafe extern "C" fn libsais_create_ctx_main(
    mut threads: sa_sint_t,
) -> *mut LIBSAIS_CONTEXT {
...
unsafe extern "C" fn libsais_radix_sort_set_markers_32s_6k_omp(
    ...
    let mut omp_block_size: fast_sint_t = k as fast_sint_t
        - 1 as std::ffi::c_int as std::ffi::c_long;
    libsais_radix_sort_set_markers_32s_6k(
        SA,
        induction_bucket,
        omp_block_start,
        omp_block_size,
...
unsafe extern "C" fn libsais_radix_sort_set_markers_32s_4k_omp(
    ...
    let mut omp_block_size: fast_sint_t = k as fast_sint_t
        - 1 as std::ffi::c_int as std::ffi::c_long;
    libsais_radix_sort_set_markers_32s_4k(
        SA,
        induction_bucket,
        omp_block_start,
        omp_block_size,
...
unsafe extern "C" fn libsais_partial_sorting_scan_left_to_right_8u(
    ...
    let mut distinct_names: *mut sa_sint_t = &mut *buckets
        .offset(
            (2 as std::ffi::c_int * ((1 as std::ffi::c_int) << 8 as std::ffi::c_int))
                as isize,
        ) as *mut sa_sint_t;
    let mut i: fast_sint_t = 0;
    let mut j: fast_sint_t = 0;
...
unsafe extern "C" fn libsais_partial_sorting_scan_right_to_left_8u(
    ...
    let mut induction_bucket: *mut sa_sint_t = &mut *buckets
        .offset(
            (0 as std::ffi::c_int * ((1 as std::ffi::c_int) << 8 as std::ffi::c_int))
                as isize,
        ) as *mut sa_sint_t;
    let mut distinct_names: *mut sa_sint_t = &mut *buckets
        .offset(
...
unsafe extern "C" fn libsais_renumber_and_gather_lms_suffixes_omp(
    ...
    let mut name: sa_sint_t = libsais_renumber_lms_suffixes_8u_omp(
        SA,
        m,
        threads,
        thread_state,
...
unsafe extern "C" fn libsais_renumber_and_mark_distinct_lms_suffixes_32s_4k_omp(
    ...
    let mut name: sa_sint_t = libsais_renumber_distinct_lms_suffixes_32s_4k_omp(
        SA,
        m,
        threads,
        thread_state,
...
unsafe extern "C" fn libsais_place_lms_suffixes_interval_8u(
    ...
    c = (((1 as std::ffi::c_int) << 8 as std::ffi::c_int) - 2 as std::ffi::c_int)
        as fast_sint_t;
...
unsafe extern "C" fn libsais_final_bwt_scan_left_to_right_8u(
    ...
    while i < j {
        ...
        let mut Ts0: *const uint8_t = &*T
            .offset(
                (if s0 > 0 as std::ffi::c_int { s0 } else { 2 as std::ffi::c_int })
                    as isize,
            ) as *const uint8_t;
        libsais_prefetchr(
            Ts0.offset(-(1 as std::ffi::c_int as isize)) as *const std::ffi::c_void,
        ...
        let mut Ts1: *const uint8_t = &*T
            .offset(
                (if s1 > 0 as std::ffi::c_int { s1 } else { 2 as std::ffi::c_int })
                    as isize,
            ) as *const uint8_t;
        libsais_prefetchr(
            Ts1.offset(-(1 as std::ffi::c_int as isize)) as *const std::ffi::c_void,
...
unsafe extern "C" fn libsais_compact_lms_suffixes_32s_omp(
    ...
    let mut f: sa_sint_t = libsais_renumber_unique_and_nonunique_lms_suffixes_32s_omp(
        T,
        SA,
        m,
        threads,
...
unsafe extern "C" fn libsais_reconstruct_compacted_lms_suffixes_32s_2k_omp(
    ...
    if f > 0 as std::ffi::c_int {
        ...
        libsais_merge_compacted_lms_suffixes_32s_omp(
            T,
            SA,
            n,
            m,
...
unsafe extern "C" fn libsais_main_32s_recursion(
                ...
                && threads == 1 as std::ffi::c_int)
    {
        ...
        if m > 1 as std::ffi::c_int {
            ...
            let mut left_suffixes_count: sa_sint_t = libsais_initialize_buckets_for_lms_suffixes_radix_sort_32s_6k(
                T,
                k,
                buckets,
                first_lms_suffix,
            ...
            libsais_induce_final_order_32s_4k(
                T,
                SA,
                n,
                k,
            ...
            *SA
            ...
            libsais_induce_final_order_32s_6k(
                T,
                SA,
                n,
                k,
                ...
                && threads == 1 as std::ffi::c_int)
    {
        ...
        if m_0 > 1 as std::ffi::c_int {
            ...
            libsais_induce_partial_order_32s_4k_omp(
                T,
                SA,
                n,
                k,
            ...
            if names_0 < m_0 {
                let mut f_0: sa_sint_t = libsais_compact_lms_suffixes_32s_omp(
                    T,
                    SA,
                    n,
                    m_0,
                ...
                && threads == 1 as std::ffi::c_int)
    {
        ...
        if m_1 > 1 as std::ffi::c_int {
            ...
            libsais_induce_partial_order_32s_2k_omp(
                T,
                SA,
                n,
                k,
            ...
            let mut names_1: sa_sint_t = libsais_renumber_and_mark_distinct_lms_suffixes_32s_1k_omp(
                T,
                SA,
                n,
                m_1,
            ...
            if names_1 < m_1 {
                let mut f_1: sa_sint_t = libsais_compact_lms_suffixes_32s_omp(
                    T,
                    SA,
                    n,
                    m_1,
        ...
        let mut m_2: sa_sint_t = libsais_radix_sort_lms_suffixes_32s_1k(
            T,
            SA,
            n,
            buckets_2,
        ...
        if m_2 > 1 as std::ffi::c_int {
            libsais_induce_partial_order_32s_1k_omp(
                T,
                SA,
                n,
                k,
            ...
            let mut names_2: sa_sint_t = libsais_renumber_and_mark_distinct_lms_suffixes_32s_1k_omp(
                T,
                SA,
                n,
                m_2,
            ...
            if names_2 < m_2 {
                ...
                let mut f_2: sa_sint_t = libsais_compact_lms_suffixes_32s_omp(
                    T,
                    SA,
                    n,
                    m_2,
...
unsafe extern "C" fn libsais_main_32s_entry(
    ...
    return libsais_main_32s_recursion(
        T,
        SA,
        n,
        k,
...
unsafe extern "C" fn libsais_main_8u(
    ...
    let mut m: sa_sint_t = libsais_count_and_gather_lms_suffixes_8u_omp(
        T,
        SA,
        n,
        buckets,
    ...
    if m > 0 as std::ffi::c_int {
        let mut first_lms_suffix: sa_sint_t = *SA.offset((n - m) as isize);
        let mut left_suffixes_count: sa_sint_t = libsais_initialize_buckets_for_lms_suffixes_radix_sort_8u(
            T,
            buckets,
            first_lms_suffix,
        );
        ...
        libsais_radix_sort_lms_suffixes_8u_omp(
            T,
            SA,
            n,
            m,
        ...
        let mut names: sa_sint_t = libsais_renumber_and_gather_lms_suffixes_omp(
            SA,
            n,
            m,
            fs,
    ...
    return libsais_induce_final_order_8u_omp(
        T,
        SA,
        n,
        k,
...
pub unsafe extern "C" fn libsais_create_ctx() -> *mut std::ffi::c_void {
    return libsais_create_ctx_main(1 as std::ffi::c_int) as *mut std::ffi::c_void;
}
#[no_mangle]
...
pub unsafe extern "C" fn libsais_int(
    ...
    return libsais_main_int(T, SA, n, k, fs, 1 as std::ffi::c_int);
}
#[no_mangle]
    ...
    if n >= 1024 as std::ffi::c_int as std::ffi::c_long {
        ...
        while T_p
            < (T.offset(63 as std::ffi::c_int as isize) as ptrdiff_t
                ...
                as *const uint8_t
        {
            let ref mut fresh209 = *copy0
                .offset(*T_p.offset(0 as std::ffi::c_int as isize) as isize);
        ...
        while T_p
            < (T.offset(n as isize).offset(-(8 as std::ffi::c_int as isize)) as ptrdiff_t
                & -(64 as std::ffi::c_int) as std::ffi::c_long) as *mut uint8_t
                as *const uint8_t
        {
            libsais_prefetchr(
                &*T_p.offset(prefetch_distance as isize) as *const uint8_t
                    as *const std::ffi::c_void,
            );
            let mut z: fast_uint_t = *(T_p as *const std::ffi::c_void as *const uint32_t)
                .offset(2 as std::ffi::c_int as isize) as fast_uint_t;
            let mut w: fast_uint_t = *(T_p as *const std::ffi::c_void as *const uint32_t)
                .offset(3 as std::ffi::c_int as isize) as fast_uint_t;
            let ref mut fresh210 = *copy0.offset(x as uint8_t as isize);
            *fresh210 = (*fresh210).wrapping_add(1);
            *fresh210;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh211 = *copy1.offset(x as uint8_t as isize);
            *fresh211 = (*fresh211).wrapping_add(1);
            *fresh211;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh212 = *copy2.offset(x as uint8_t as isize);
            *fresh212 = (*fresh212).wrapping_add(1);
            *fresh212;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh213 = *copy3.offset(x as isize);
            *fresh213 = (*fresh213).wrapping_add(1);
            *fresh213;
            let ref mut fresh214 = *copy0.offset(y as uint8_t as isize);
            *fresh214 = (*fresh214).wrapping_add(1);
            *fresh214;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh215 = *copy1.offset(y as uint8_t as isize);
            *fresh215 = (*fresh215).wrapping_add(1);
            *fresh215;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh216 = *copy2.offset(y as uint8_t as isize);
            *fresh216 = (*fresh216).wrapping_add(1);
            *fresh216;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh217 = *copy3.offset(y as isize);
            ...
            *fresh217;
            ...
            let ref mut fresh218 = *copy0.offset(z as uint8_t as isize);
            *fresh218 = (*fresh218).wrapping_add(1);
            *fresh218;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh219 = *copy1.offset(z as uint8_t as isize);
            *fresh219 = (*fresh219).wrapping_add(1);
            *fresh219;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh220 = *copy2.offset(z as uint8_t as isize);
            *fresh220 = (*fresh220).wrapping_add(1);
            *fresh220;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh221 = *copy3.offset(z as isize);
            *fresh221 = (*fresh221).wrapping_add(1);
            *fresh221;
            let ref mut fresh222 = *copy0.offset(w as uint8_t as isize);
            *fresh222 = (*fresh222).wrapping_add(1);
            *fresh222;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh223 = *copy1.offset(w as uint8_t as isize);
            *fresh223 = (*fresh223).wrapping_add(1);
            *fresh223;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh224 = *copy2.offset(w as uint8_t as isize);
            *fresh224 = (*fresh224).wrapping_add(1);
            *fresh224;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh225 = *copy3.offset(w as isize);
            ...
            *fresh225;
            ...
            let ref mut fresh226 = *copy0.offset(x as uint8_t as isize);
            *fresh226 = (*fresh226).wrapping_add(1);
            *fresh226;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh227 = *copy1.offset(x as uint8_t as isize);
            *fresh227 = (*fresh227).wrapping_add(1);
            *fresh227;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh228 = *copy2.offset(x as uint8_t as isize);
            *fresh228 = (*fresh228).wrapping_add(1);
            *fresh228;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh229 = *copy3.offset(x as isize);
            *fresh229 = (*fresh229).wrapping_add(1);
            *fresh229;
            let ref mut fresh230 = *copy0.offset(y as uint8_t as isize);
            *fresh230 = (*fresh230).wrapping_add(1);
            *fresh230;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh231 = *copy1.offset(y as uint8_t as isize);
            *fresh231 = (*fresh231).wrapping_add(1);
            *fresh231;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh232 = *copy2.offset(y as uint8_t as isize);
            *fresh232 = (*fresh232).wrapping_add(1);
            *fresh232;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh233 = *copy3.offset(y as isize);
            ...
            *fresh233;
            ...
            let ref mut fresh234 = *copy0.offset(z as uint8_t as isize);
            *fresh234 = (*fresh234).wrapping_add(1);
            *fresh234;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh235 = *copy1.offset(z as uint8_t as isize);
            *fresh235 = (*fresh235).wrapping_add(1);
            *fresh235;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh236 = *copy2.offset(z as uint8_t as isize);
            *fresh236 = (*fresh236).wrapping_add(1);
            *fresh236;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh237 = *copy3.offset(z as isize);
            *fresh237 = (*fresh237).wrapping_add(1);
            *fresh237;
            let ref mut fresh238 = *copy0.offset(w as uint8_t as isize);
            *fresh238 = (*fresh238).wrapping_add(1);
            *fresh238;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh239 = *copy1.offset(w as uint8_t as isize);
            *fresh239 = (*fresh239).wrapping_add(1);
            *fresh239;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh240 = *copy2.offset(w as uint8_t as isize);
            *fresh240 = (*fresh240).wrapping_add(1);
            *fresh240;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh241 = *copy3.offset(w as isize);
            ...
            *fresh241;
            ...
            let ref mut fresh242 = *copy0.offset(x as uint8_t as isize);
            *fresh242 = (*fresh242).wrapping_add(1);
            *fresh242;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh243 = *copy1.offset(x as uint8_t as isize);
            *fresh243 = (*fresh243).wrapping_add(1);
            *fresh243;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh244 = *copy2.offset(x as uint8_t as isize);
            *fresh244 = (*fresh244).wrapping_add(1);
            *fresh244;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh245 = *copy3.offset(x as isize);
            *fresh245 = (*fresh245).wrapping_add(1);
            *fresh245;
            let ref mut fresh246 = *copy0.offset(y as uint8_t as isize);
            *fresh246 = (*fresh246).wrapping_add(1);
            *fresh246;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh247 = *copy1.offset(y as uint8_t as isize);
            *fresh247 = (*fresh247).wrapping_add(1);
            *fresh247;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh248 = *copy2.offset(y as uint8_t as isize);
            *fresh248 = (*fresh248).wrapping_add(1);
            *fresh248;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh249 = *copy3.offset(y as isize);
            ...
            *fresh249;
            ...
            let ref mut fresh250 = *copy0.offset(z as uint8_t as isize);
            *fresh250 = (*fresh250).wrapping_add(1);
            *fresh250;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh251 = *copy1.offset(z as uint8_t as isize);
            *fresh251 = (*fresh251).wrapping_add(1);
            *fresh251;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh252 = *copy2.offset(z as uint8_t as isize);
            *fresh252 = (*fresh252).wrapping_add(1);
            *fresh252;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh253 = *copy3.offset(z as isize);
            *fresh253 = (*fresh253).wrapping_add(1);
            *fresh253;
            let ref mut fresh254 = *copy0.offset(w as uint8_t as isize);
            *fresh254 = (*fresh254).wrapping_add(1);
            *fresh254;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh255 = *copy1.offset(w as uint8_t as isize);
            *fresh255 = (*fresh255).wrapping_add(1);
            *fresh255;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh256 = *copy2.offset(w as uint8_t as isize);
            *fresh256 = (*fresh256).wrapping_add(1);
            *fresh256;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh257 = *copy3.offset(w as isize);
            ...
            *fresh257;
            ...
            let ref mut fresh258 = *copy0.offset(x as uint8_t as isize);
            *fresh258 = (*fresh258).wrapping_add(1);
            *fresh258;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh259 = *copy1.offset(x as uint8_t as isize);
            *fresh259 = (*fresh259).wrapping_add(1);
            *fresh259;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh260 = *copy2.offset(x as uint8_t as isize);
            *fresh260 = (*fresh260).wrapping_add(1);
            *fresh260;
            x >>= 8 as std::ffi::c_int;
            let ref mut fresh261 = *copy3.offset(x as isize);
            *fresh261 = (*fresh261).wrapping_add(1);
            *fresh261;
            let ref mut fresh262 = *copy0.offset(y as uint8_t as isize);
            *fresh262 = (*fresh262).wrapping_add(1);
            *fresh262;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh263 = *copy1.offset(y as uint8_t as isize);
            *fresh263 = (*fresh263).wrapping_add(1);
            *fresh263;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh264 = *copy2.offset(y as uint8_t as isize);
            *fresh264 = (*fresh264).wrapping_add(1);
            *fresh264;
            y >>= 8 as std::ffi::c_int;
            let ref mut fresh265 = *copy3.offset(y as isize);
            ...
            *fresh265;
            ...
            let ref mut fresh266 = *copy0.offset(z as uint8_t as isize);
            *fresh266 = (*fresh266).wrapping_add(1);
            *fresh266;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh267 = *copy1.offset(z as uint8_t as isize);
            *fresh267 = (*fresh267).wrapping_add(1);
            *fresh267;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh268 = *copy2.offset(z as uint8_t as isize);
            *fresh268 = (*fresh268).wrapping_add(1);
            *fresh268;
            z >>= 8 as std::ffi::c_int;
            let ref mut fresh269 = *copy3.offset(z as isize);
            *fresh269 = (*fresh269).wrapping_add(1);
            *fresh269;
            let ref mut fresh270 = *copy0.offset(w as uint8_t as isize);
            *fresh270 = (*fresh270).wrapping_add(1);
            *fresh270;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh271 = *copy1.offset(w as uint8_t as isize);
            *fresh271 = (*fresh271).wrapping_add(1);
            *fresh271;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh272 = *copy2.offset(w as uint8_t as isize);
            *fresh272 = (*fresh272).wrapping_add(1);
            *fresh272;
            w >>= 8 as std::ffi::c_int;
            let ref mut fresh273 = *copy3.offset(w as isize);
            *fresh273 = (*fresh273).wrapping_add(1);
            *fresh273;
            T_p = T_p.offset(64 as std::ffi::c_int as isize);
        }
        let ref mut fresh274 = *copy0.offset(x as uint8_t as isize);
        *fresh274 = (*fresh274).wrapping_add(1);
        *fresh274;
        x >>= 8 as std::ffi::c_int;
        let ref mut fresh275 = *copy1.offset(x as uint8_t as isize);
        *fresh275 = (*fresh275).wrapping_add(1);
        *fresh275;
        x >>= 8 as std::ffi::c_int;
        let ref mut fresh276 = *copy2.offset(x as uint8_t as isize);
        *fresh276 = (*fresh276).wrapping_add(1);
        *fresh276;
        x >>= 8 as std::ffi::c_int;
        let ref mut fresh277 = *copy3.offset(x as isize);
        *fresh277 = (*fresh277).wrapping_add(1);
        *fresh277;
        let ref mut fresh278 = *copy0.offset(y as uint8_t as isize);
        *fresh278 = (*fresh278).wrapping_add(1);
        *fresh278;
        y >>= 8 as std::ffi::c_int;
        let ref mut fresh279 = *copy1.offset(y as uint8_t as isize);
        *fresh279 = (*fresh279).wrapping_add(1);
        *fresh279;
        y >>= 8 as std::ffi::c_int;
        let ref mut fresh280 = *copy2.offset(y as uint8_t as isize);
        *fresh280 = (*fresh280).wrapping_add(1);
        *fresh280;
        y >>= 8 as std::ffi::c_int;
        let ref mut fresh281 = *copy3.offset(y as isize);
        ...
        *fresh281;
        ...
        while i < ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
            let ref mut fresh282 = *count.offset(i as isize);
            *fresh282 = (*fresh282 as std::ffi::c_uint)
                .wrapping_add(
    ...
    while x != ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
        ...
        while c != x.wrapping_add(16 as std::ffi::c_int as std::ffi::c_ulong) {
            ...
            while d != x.wrapping_add(16 as std::ffi::c_int as std::ffi::c_ulong) {
                let mut tmp: sa_uint_t = *bucket2
                    .offset((d << 8 as std::ffi::c_int).wrapping_add(c) as isize);
                *bucket2
                    .offset(
                        (d << 8 as std::ffi::c_int).wrapping_add(c) as isize,
                    ) = *bucket2
                    .offset((c << 8 as std::ffi::c_int).wrapping_add(d) as isize);
                *bucket2
                    .offset((c << 8 as std::ffi::c_int).wrapping_add(d) as isize) = tmp;
                d = d.wrapping_add(1);
                d;
            }
            c = c.wrapping_add(1);
        ...
        while y != ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong
        {
            ...
            while c != x.wrapping_add(16 as std::ffi::c_int as std::ffi::c_ulong) {
                ...
                let mut bucket2_cy: *mut sa_uint_t = &mut *bucket2
                    ...
                    as *mut sa_uint_t;
                let mut tmp00: sa_uint_t = *bucket2_yc
                    .offset((0 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (0 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(0 as std::ffi::c_int as isize);
                *bucket2_cy.offset(0 as std::ffi::c_int as isize) = tmp00;
                let mut tmp01: sa_uint_t = *bucket2_yc
                    .offset((1 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (1 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(1 as std::ffi::c_int as isize);
                *bucket2_cy.offset(1 as std::ffi::c_int as isize) = tmp01;
                let mut tmp02: sa_uint_t = *bucket2_yc
                    .offset((2 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (2 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(2 as std::ffi::c_int as isize);
                *bucket2_cy.offset(2 as std::ffi::c_int as isize) = tmp02;
                let mut tmp03: sa_uint_t = *bucket2_yc
                    .offset((3 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (3 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(3 as std::ffi::c_int as isize);
                *bucket2_cy.offset(3 as std::ffi::c_int as isize) = tmp03;
                let mut tmp04: sa_uint_t = *bucket2_yc
                    .offset((4 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (4 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(4 as std::ffi::c_int as isize);
                *bucket2_cy.offset(4 as std::ffi::c_int as isize) = tmp04;
                let mut tmp05: sa_uint_t = *bucket2_yc
                    .offset((5 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (5 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(5 as std::ffi::c_int as isize);
                *bucket2_cy.offset(5 as std::ffi::c_int as isize) = tmp05;
                let mut tmp06: sa_uint_t = *bucket2_yc
                    .offset((6 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (6 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(6 as std::ffi::c_int as isize);
                *bucket2_cy.offset(6 as std::ffi::c_int as isize) = tmp06;
                let mut tmp07: sa_uint_t = *bucket2_yc
                    .offset((7 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (7 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(7 as std::ffi::c_int as isize);
                *bucket2_cy.offset(7 as std::ffi::c_int as isize) = tmp07;
                let mut tmp08: sa_uint_t = *bucket2_yc
                    .offset((8 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (8 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(8 as std::ffi::c_int as isize);
                *bucket2_cy.offset(8 as std::ffi::c_int as isize) = tmp08;
                let mut tmp09: sa_uint_t = *bucket2_yc
                    .offset((9 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (9 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(9 as std::ffi::c_int as isize);
                *bucket2_cy.offset(9 as std::ffi::c_int as isize) = tmp09;
                let mut tmp10: sa_uint_t = *bucket2_yc
                    .offset((10 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (10 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(10 as std::ffi::c_int as isize);
                *bucket2_cy.offset(10 as std::ffi::c_int as isize) = tmp10;
                let mut tmp11: sa_uint_t = *bucket2_yc
                    .offset((11 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (11 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(11 as std::ffi::c_int as isize);
                *bucket2_cy.offset(11 as std::ffi::c_int as isize) = tmp11;
                let mut tmp12: sa_uint_t = *bucket2_yc
                    .offset((12 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (12 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(12 as std::ffi::c_int as isize);
                *bucket2_cy.offset(12 as std::ffi::c_int as isize) = tmp12;
                let mut tmp13: sa_uint_t = *bucket2_yc
                    .offset((13 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (13 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(13 as std::ffi::c_int as isize);
                *bucket2_cy.offset(13 as std::ffi::c_int as isize) = tmp13;
                let mut tmp14: sa_uint_t = *bucket2_yc
                    .offset((14 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (14 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(14 as std::ffi::c_int as isize);
                *bucket2_cy.offset(14 as std::ffi::c_int as isize) = tmp14;
                let mut tmp15: sa_uint_t = *bucket2_yc
                    .offset((15 as std::ffi::c_int * 256 as std::ffi::c_int) as isize);
                *bucket2_yc
                    .offset(
                        (15 as std::ffi::c_int * 256 as std::ffi::c_int) as isize,
                    ) = *bucket2_cy.offset(15 as std::ffi::c_int as isize);
                *bucket2_cy.offset(15 as std::ffi::c_int as isize) = tmp15;
                c = c.wrapping_add(1);
                c;
            }
            y = (y as std::ffi::c_ulong)
                .wrapping_add(16 as std::ffi::c_int as std::ffi::c_ulong) as fast_uint_t
                as fast_uint_t;
        }
        x = (x as std::ffi::c_ulong)
            .wrapping_add(16 as std::ffi::c_int as std::ffi::c_ulong) as fast_uint_t
            as fast_uint_t;
    }
}
unsafe extern "C" fn libsais_unbwt_compute_bigram_histogram_single(
    ...
    while c < ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
        ...
        *bucket1.offset(c as isize) = prev as sa_uint_t;
        if prev != sum {
            let mut bucket2_p: *mut sa_uint_t = &mut *bucket2
                .offset((c << 8 as std::ffi::c_int) as isize) as *mut sa_uint_t;
            ...
            libsais_unbwt_compute_histogram(
                &*T
                    .offset(
                        lo.wrapping_sub(1 as std::ffi::c_int as std::ffi::c_ulong)
                            as isize,
                    ),
...
unsafe extern "C" fn libsais_unbwt_calculate_fastbits(
    ...
    while c < ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
        if c == lastc {
            sum = (sum as std::ffi::c_ulong)
                .wrapping_add(1 as std::ffi::c_int as std::ffi::c_ulong) as fast_uint_t
                as fast_uint_t;
        }
        ...
        while d < ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
            ...
            *bucket2.offset(w as isize) = prev as sa_uint_t;
            if prev != sum {
                while v
                    <= sum.wrapping_sub(1 as std::ffi::c_int as std::ffi::c_ulong)
                        >> shift
                {
...
unsafe extern "C" fn libsais_unbwt_calculate_biPSI(
    ...
    while i < j {
        ...
        let ref mut fresh284 = *bucket1.offset(c as isize);
        ...
        *fresh284 = (*fresh284).wrapping_add(1);
        ...
        if t != 0 as std::ffi::c_int as std::ffi::c_long {
            let mut w: fast_uint_t = ((*T
                .offset(
                    p
                        .wrapping_add(
                            (t
                                >> (::core::mem::size_of::<fast_sint_t>()
                                    as std::ffi::c_ulong)
                                    .wrapping_mul(8 as std::ffi::c_int as std::ffi::c_ulong)
                                    .wrapping_sub(1 as std::ffi::c_int as std::ffi::c_ulong))
                                as fast_uint_t,
                        ) as isize,
                ) as fast_uint_t) << 8 as std::ffi::c_int)
                .wrapping_add(c);
            let ref mut fresh286 = *bucket2.offset(w as isize);
    ...
    i_0 += 1 as std::ffi::c_int as std::ffi::c_long;
    while i_0 <= j_0 {
        let mut c_0: fast_uint_t = *T
            .offset((i_0 - 1 as std::ffi::c_int as std::ffi::c_long) as isize)
            as fast_uint_t;
        let ref mut fresh288 = *bucket1.offset(c_0 as isize);
        ...
        *fresh288 = (*fresh288).wrapping_add(1);
        ...
        if t_0 != 0 as std::ffi::c_int as std::ffi::c_long {
            let mut w_0: fast_uint_t = ((*T
                ...
                .wrapping_add(c_0);
            let ref mut fresh290 = *bucket2.offset(w_0 as isize);
...
unsafe extern "C" fn libsais_unbwt_init_single(
    ...
    libsais_unbwt_compute_bigram_histogram_single(
        T,
        bucket1.as_mut_ptr(),
        bucket2,
        index,
...
unsafe extern "C" fn libsais_unbwt_decode_2(
    ...
    let mut U0: *mut uint16_t = U as *mut std::ffi::c_void as *mut uint16_t;
    let mut U1: *mut uint16_t = (U0 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
...
unsafe extern "C" fn libsais_unbwt_decode_3(
    ...
    let mut U1: *mut uint16_t = (U0 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut U2: *mut uint16_t = (U1 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
    let mut p1: fast_uint_t = *i1;
...
unsafe extern "C" fn libsais_unbwt_decode_4(
    ...
    let mut U2: *mut uint16_t = (U1 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut U3: *mut uint16_t = (U2 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
    let mut p1: fast_uint_t = *i1;
...
unsafe extern "C" fn libsais_unbwt_decode_5(
    ...
    let mut U3: *mut uint16_t = (U2 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut U4: *mut uint16_t = (U3 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
    let mut p1: fast_uint_t = *i1;
...
unsafe extern "C" fn libsais_unbwt_decode_6(
    ...
    let mut U4: *mut uint16_t = (U3 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut U5: *mut uint16_t = (U4 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
    let mut p1: fast_uint_t = *i1;
...
unsafe extern "C" fn libsais_unbwt_decode_7(
    ...
    let mut U5: *mut uint16_t = (U4 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut U6: *mut uint16_t = (U5 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
    let mut p1: fast_uint_t = *i1;
...
unsafe extern "C" fn libsais_unbwt_decode_8(
    ...
    let mut U6: *mut uint16_t = (U5 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut U7: *mut uint16_t = (U6 as *mut uint8_t).offset(r as isize)
        as *mut std::ffi::c_void as *mut uint16_t;
    let mut i: fast_uint_t = 0;
    let mut p0: fast_uint_t = *i0;
    let mut p1: fast_uint_t = *i1;
...
pub unsafe extern "C" fn libsais_unbwt_create_ctx() -> *mut std::ffi::c_void {
    return libsais_unbwt_create_ctx_main(1 as std::ffi::c_int) as *mut std::ffi::c_void;
}
#[no_mangle]
...
pub unsafe extern "C" fn libsais_unbwt(
    ...
    return libsais_unbwt_aux(T, U, A, n, freq, n, &mut i);
}
#[no_mangle]
pub unsafe extern "C" fn libsais_unbwt_ctx(
    ...
    return libsais_unbwt_aux_ctx(ctx, T, U, A, n, freq, n, &mut i);
}
#[no_mangle]
