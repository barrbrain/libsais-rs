...
unsafe fn libsais_prefetchr(p: *const std::ffi::c_void) {
...
unsafe fn libsais_prefetchw(p: *const std::ffi::c_void) {
    #[cfg(target_arch = "x86_64")]
    core::arch::x86_64::_mm_prefetch(
        core::mem::transmute::<*const std::ffi::c_void, *mut i8>(p),
...
unsafe extern "C" fn libsais_alloc_aligned(
    mut size: size_t,
    mut alignment: size_t,
) -> *mut std::ffi::c_void {
    ...
    if !address.is_null() {
        let mut aligned_address: *mut std::ffi::c_void = libsais_align_up(
...
unsafe extern "C" fn libsais_free_aligned(mut aligned_address: *mut std::ffi::c_void) {
...
unsafe extern "C" fn libsais_alloc_thread_state(
    ...
    libsais_free_aligned(thread_cache as *mut std::ffi::c_void);
    libsais_free_aligned(thread_buckets as *mut std::ffi::c_void);
    libsais_free_aligned(thread_state as *mut std::ffi::c_void);
...
unsafe extern "C" fn libsais_create_ctx_main(mut threads: sa_sint_t) -> *mut LIBSAIS_CONTEXT {
    ...
    libsais_free_aligned(buckets as *mut std::ffi::c_void);
    libsais_free_aligned(ctx as *mut std::ffi::c_void);
...
unsafe extern "C" fn libsais_free_ctx_main(mut ctx: *mut LIBSAIS_CONTEXT) {
    if !ctx.is_null() {
        ...
        libsais_free_aligned((*ctx).buckets as *mut std::ffi::c_void);
        libsais_free_aligned(ctx as *mut std::ffi::c_void);
    }
}
...
unsafe extern "C" fn libsais_radix_sort_lms_suffixes_32s_6k(
    ...
    while i >= j {
        ...
        libsais_prefetchr(&*T.offset(*SA.offset(
        ...
        libsais_prefetchw(&mut *induction_bucket.offset(*T.offset(
            *SA.offset((i - prefetch_distance - 0 as std::ffi::c_int as std::ffi::c_long) as isize)
                as isize,
...
unsafe extern "C" fn libsais_radix_sort_lms_suffixes_32s_1k(
    ...
    while i as std::ffi::c_long >= prefetch_distance + 3 as std::ffi::c_int as std::ffi::c_long {
        ...
        libsais_prefetchw(&mut *buckets.offset(*T.offset(
...
unsafe extern "C" fn libsais_partial_sorting_scan_left_to_right_32s_4k(
    ...
    while i < j {
        ...
        libsais_prefetchr(Ts0.offset(-(1 as std::ffi::c_int as isize)) as *const std::ffi::c_void);
        libsais_prefetchr(Ts0.offset(-(2 as std::ffi::c_int as isize)) as *const std::ffi::c_void);
        ...
        libsais_prefetchr(Ts1.offset(-(1 as std::ffi::c_int as isize)) as *const std::ffi::c_void);
        libsais_prefetchr(Ts1.offset(-(2 as std::ffi::c_int as isize)) as *const std::ffi::c_void);
        ...
        if s2 > 0 as std::ffi::c_int {
            ...
            libsais_prefetchw(&mut *distinct_names.offset(
...
unsafe extern "C" fn libsais_partial_sorting_shift_markers_8u_omp(
    ...
    c = (((((1 as std::ffi::c_int) << 8 as std::ffi::c_int) - 1 as std::ffi::c_int)
        << 1 as std::ffi::c_int)
        + 0 as std::ffi::c_int) as fast_sint_t;
    while c
...
unsafe extern "C" fn libsais_renumber_lms_suffixes_8u_omp(
    ...
    if omp_num_threads == 1 as std::ffi::c_int as std::ffi::c_long {
        name = libsais_renumber_lms_suffixes_8u(
            SA,
            m,
            0 as std::ffi::c_int,
            omp_block_start,
...
unsafe extern "C" fn libsais_renumber_unique_and_nonunique_lms_suffixes_32s(
    ...
    j = omp_block_start as sa_sint_t + omp_block_size as sa_sint_t
        ...
        - 3 as std::ffi::c_int;
    while i < j {
        libsais_prefetchr(&mut *SA.offset(
...
unsafe extern "C" fn libsais_main_32s_recursion(
                ...
                && threads == 1 as std::ffi::c_int)
    {
        ...
        if m_0 > 1 as std::ffi::c_int {
            ...
            libsais_place_lms_suffixes_interval_32s_4k(
                SA,
                n,
                k,
                ...
                && threads == 1 as std::ffi::c_int)
    {
        ...
        if m_1 > 1 as std::ffi::c_int {
            ...
            libsais_place_lms_suffixes_interval_32s_2k(
                SA,
                n,
                k,
        ...
        if m_2 > 1 as std::ffi::c_int {
            ...
            if names_2 < m_2 {
                if !buffer.is_null() {
                    libsais_free_aligned(buffer as *mut std::ffi::c_void);
...
#[no_mangle]
pub unsafe extern "C" fn libsais_create_ctx() -> *mut std::ffi::c_void {
    libsais_create_ctx_main(1 as std::ffi::c_int) as *mut std::ffi::c_void
}
#[no_mangle]
pub unsafe extern "C" fn libsais_free_ctx(mut ctx: *mut std::ffi::c_void) {
...
pub unsafe extern "C" fn libsais_int(
    ...
    libsais_main_int(T, SA, n, k, fs, 1 as std::ffi::c_int)
}
#[no_mangle]
...
unsafe extern "C" fn libsais_unbwt_create_ctx_main(
    ...
    libsais_free_aligned(buckets as *mut std::ffi::c_void);
    libsais_free_aligned(fastbits as *mut std::ffi::c_void);
    libsais_free_aligned(bucket2 as *mut std::ffi::c_void);
    libsais_free_aligned(ctx as *mut std::ffi::c_void);
...
unsafe extern "C" fn libsais_unbwt_free_ctx_main(mut ctx: *mut LIBSAIS_UNBWT_CONTEXT) {
    if !ctx.is_null() {
        libsais_free_aligned((*ctx).buckets as *mut std::ffi::c_void);
        libsais_free_aligned((*ctx).fastbits as *mut std::ffi::c_void);
        libsais_free_aligned((*ctx).bucket2 as *mut std::ffi::c_void);
        libsais_free_aligned(ctx as *mut std::ffi::c_void);
    }
}
unsafe extern "C" fn libsais_unbwt_compute_histogram(
    ...
    if n >= 1024 as std::ffi::c_int as std::ffi::c_long {
        ...
        while T_p
            < (T.offset(n as isize)
                ...
                as *const uint8_t
        {
            libsais_prefetchr(&*T_p.offset(prefetch_distance as isize) as *const uint8_t
                as *const std::ffi::c_void);
        ...
        *fresh281 = (*fresh281).wrapping_add(1);
        ...
        while i < ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
            ...
            *fresh282 = (*fresh282 as std::ffi::c_uint).wrapping_add(
    ...
    while T_p < T.offset(n as isize) {
        let fresh283 = &mut (*count.offset(*T_p.offset(0 as std::ffi::c_int as isize) as isize));
...
unsafe extern "C" fn libsais_unbwt_compute_bigram_histogram_single(
    ...
    while c < ((1 as std::ffi::c_int) << 8 as std::ffi::c_int) as std::ffi::c_ulong {
        ...
        sum = (sum as std::ffi::c_ulong)
            .wrapping_add(*bucket1.offset(c as isize) as std::ffi::c_ulong)
            as fast_uint_t as fast_uint_t;
...
unsafe extern "C" fn libsais_unbwt_decode_omp(
    ...
    *U.offset((n - 1 as std::ffi::c_int) as isize) = lastc as uint8_t;
}
...
#[no_mangle]
pub unsafe extern "C" fn libsais_unbwt_create_ctx() -> *mut std::ffi::c_void {
    libsais_unbwt_create_ctx_main(1 as std::ffi::c_int) as *mut std::ffi::c_void
}
#[no_mangle]
pub unsafe extern "C" fn libsais_unbwt_free_ctx(mut ctx: *mut std::ffi::c_void) {
...
unsafe extern "C" fn libsais_compute_phi(
    ...
    while i < j {
        ...
        libsais_prefetchw(&mut *PLCP.offset(
            *SA.offset((i + prefetch_distance + 0 as std::ffi::c_int as std::ffi::c_long) as isize)
                as isize,
        ) as *mut sa_sint_t as *const std::ffi::c_void);
        libsais_prefetchw(&mut *PLCP.offset(
...
unsafe extern "C" fn libsais_compute_plcp_int(
    ...
    while i < j {
        ...
        libsais_prefetchr(&*T.offset(
            (*PLCP.offset((i + prefetch_distance) as isize) as std::ffi::c_long + l) as isize,
        ) as *const int32_t as *const std::ffi::c_void);
        let mut k: fast_sint_t = *PLCP.offset(i as isize) as fast_sint_t;
        let mut m: fast_sint_t = n - (if i > k { i } else { k });
...
pub unsafe extern "C" fn libsais_plcp(
    ...
    libsais_compute_phi_omp(SA, PLCP, n, 1 as std::ffi::c_int);
    libsais_compute_plcp_omp(T, PLCP, n, 1 as std::ffi::c_int);
    0 as std::ffi::c_int
}
#[no_mangle]
pub unsafe extern "C" fn libsais_plcp_gsa(
    ...
    libsais_compute_phi_omp(SA, PLCP, n, 1 as std::ffi::c_int);
    libsais_compute_plcp_gsa_omp(T, PLCP, n, 1 as std::ffi::c_int);
    0 as std::ffi::c_int
}
#[no_mangle]
pub unsafe extern "C" fn libsais_plcp_int(
    ...
    libsais_compute_phi_omp(SA, PLCP, n, 1 as std::ffi::c_int);
    libsais_compute_plcp_int_omp(T, PLCP, n, 1 as std::ffi::c_int);
    0 as std::ffi::c_int
}
#[no_mangle]
pub unsafe extern "C" fn libsais_lcp(
    ...
    libsais_compute_lcp_omp(PLCP, SA, LCP, n, 1 as std::ffi::c_int);
    0 as std::ffi::c_int
}
